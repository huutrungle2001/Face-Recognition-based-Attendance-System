...
def login_screen(window_1):
	...
	# ============ Sign In label =============================================
	# ========================================================================
	sign_in_label = Label(frame, text="Sign In", bg="#040405", fg="white",
							font=("yu gothic ui", 17, "bold"))
	sign_in_label.place(x=280, y=160)


	username_label = Label(frame, text="Username", bg="#040405", fg="#4f4e4d",
								font=("yu gothic ui", 13, "bold"))
	username_label.place(x=170, y=220)

	username_entry = Entry(frame, highlightthickness=0, relief=FLAT, bg="#040405", fg="#6b6a69",
								font=("yu gothic ui ", 12, "bold"))
	username_entry.place(x=200, y=265, width=270)

	username_line = Canvas(frame, width=300, height=2.0, bg="#bdb9b1", highlightthickness=0)
	...
	frameusername_icon_label = Label(frame, image=photo, bg='#040405')
	...
	password_label = Label(frame, text="Password", bg="#040405", fg="#4f4e4d",
										font=("yu gothic ui", 13, "bold"))
	password_label.place(x=170, y=310)

	password_entry = Entry(frame, highlightthickness=0, relief=FLAT, bg="#040405", fg="#6b6a69",
							font=("yu gothic ui", 12, "bold"), show="*")
	password_entry.place(x=200, y=346, width=244)

	password_line = Canvas(frame, width=300, height=2.0, bg="#bdb9b1", highlightthickness=0)
	password_line.place(x=170, y=370)
	# ======== Password icon ================
	password_icon = Image.open('./IconImage/password_icon.png')
	photo = ImageTk.PhotoImage(password_icon)
	password_icon_label = Label(frame, image=photo, bg='#040405')
